...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    'zh': {
      ...
      'api_settings': 'API',
      'account_data_title': '账号与数据',
      'account_data_subtitle': '数据导出与账号注销',
      'about_title': '关于',
    ...
    'es': {
      ...
      'login_with_wallet': 'Iniciar sesión con billetera',
    ...
    'ar': {
      ...
      'login_with_wallet': 'تسجيل الدخول بالمحفظة',
    ...
    'fr': {
      ...
      'login_with_wallet': 'Se connecter avec portefeuille',
    ...
    'ru': {
      ...
      'login_with_wallet': 'Войти с кошельком',
