...
const Map<String, Map<String, String>> kLocalizedValues = <String, Map<String, String>>{
  "ar": <String, String>{
    ...
    "settings_editor_default_wrap_hint": "افتح المحررات مع تفعيل التفاف الكلمات بشكل افتراضي.",
    "settings_editor_engine": "محرك المحرر",
    "settings_editor_engine_flutter_code_editor": "Flutter Code Editor",
    "settings_editor_engine_flutter_code_editor_hint": "يبقى Flutter Code Editor أصليًا بالكامل داخل Flutter ويحافظ على سير العمل الحالي لطيّ الكود.",
    "settings_editor_engine_flutter_monaco": "Flutter Monaco",
    "settings_editor_engine_flutter_monaco_hint": "يستخدم Monaco واجهة WebView/iframe على مستوى المنصة للحصول على أداء أفضل مع الملفات الكبيرة.",
    "settings_editor_font_size": "حجم الخط",
    "settings_editor_footer": "اختر سمتين منفصلتين للوضع الفاتح والداكن، ثم قرر ما إذا كان المحرر سيتبع مظهر التطبيق أو سيبقى ثابتًا.",
    "settings_editor_light_theme": "السمة الفاتحة",
    "settings_editor_preview_comment": "معاينة بأسلوب VS Code",
    "settings_editor_saved_message": "تم حفظ السمة الفاتحة والسمة الداكنة ووضع المظهر وتفضيلات المحرر.",
    "settings_editor_show_rulers": "إظهار المساطر",
    "settings_editor_show_rulers_hint": "اعرض مساطر عمودية عند العمودين 80 و120.",
    "settings_editor_subtitle": "اضبط مظهر المحرر ليقترب من تجربة مساحة العمل على نمط VS Code.",
  ...
  "en": <String, String>{
    ...
    "settings_editor_default_wrap_hint": "Open editors with word wrap enabled by default.",
    "settings_editor_engine": "Editor Engine",
    "settings_editor_engine_flutter_code_editor": "Flutter Code Editor",
    "settings_editor_engine_flutter_code_editor_hint": "Flutter Code Editor stays fully native in Flutter and keeps the current folding workflow.",
    "settings_editor_engine_flutter_monaco": "Flutter Monaco",
    "settings_editor_engine_flutter_monaco_hint": "Monaco uses a platform WebView/iframe backend for better large-file behavior.",
    "settings_editor_font_size": "Font Size",
    "settings_editor_footer": "Pick separate light and dark editor themes, then decide whether the editor follows the app appearance or stays fixed.",
    "settings_editor_light_theme": "Light Theme",
    "settings_editor_preview_comment": "VS Code-style preview",
    "settings_editor_saved_message": "Light theme, dark theme, appearance mode, and editor preferences saved.",
    "settings_editor_show_rulers": "Show Rulers",
    "settings_editor_show_rulers_hint": "Display vertical rulers at columns 80 and 120.",
    "settings_editor_subtitle": "Tune editor visuals toward a VS Code-style workbench.",
  ...
  "es": <String, String>{
    ...
    "settings_editor_default_wrap_hint": "Abrir los editores con ajuste de línea activado por defecto.",
    "settings_editor_engine": "Motor del editor",
    "settings_editor_engine_flutter_code_editor": "Flutter Code Editor",
    "settings_editor_engine_flutter_code_editor_hint": "Flutter Code Editor se mantiene totalmente nativo en Flutter y conserva el flujo actual de plegado de código.",
    "settings_editor_engine_flutter_monaco": "Flutter Monaco",
    "settings_editor_engine_flutter_monaco_hint": "Monaco usa un backend WebView/iframe de la plataforma para comportarse mejor con archivos grandes.",
    "settings_editor_font_size": "Tamaño de fuente",
    "settings_editor_footer": "Elige por separado los temas claro y oscuro, y decide si el editor sigue la apariencia de la app o permanece fijo.",
    "settings_editor_light_theme": "Tema claro",
    "settings_editor_preview_comment": "Vista previa estilo VS Code",
    "settings_editor_saved_message": "Se guardaron el tema claro, el tema oscuro, el modo de apariencia y las preferencias del editor.",
    "settings_editor_show_rulers": "Mostrar reglas",
    "settings_editor_show_rulers_hint": "Muestra reglas verticales en las columnas 80 y 120.",
    "settings_editor_subtitle": "Ajusta la apariencia del editor para acercarla a una experiencia tipo VS Code.",
  ...
  "fr": <String, String>{
    ...
    "settings_editor_default_wrap_hint": "Ouvrir les éditeurs avec le retour à la ligne activé par défaut.",
    "settings_editor_engine": "Moteur de l’éditeur",
    "settings_editor_engine_flutter_code_editor": "Flutter Code Editor",
    "settings_editor_engine_flutter_code_editor_hint": "Flutter Code Editor reste entièrement natif dans Flutter et conserve le flux actuel de pliage du code.",
    "settings_editor_engine_flutter_monaco": "Flutter Monaco",
    "settings_editor_engine_flutter_monaco_hint": "Monaco utilise un backend WebView/iframe de la plateforme pour mieux gérer les fichiers volumineux.",
    "settings_editor_font_size": "Taille de police",
    "settings_editor_footer": "Choisissez séparément les thèmes clair et sombre, puis décidez si l’éditeur suit l’apparence de l’application ou reste fixe.",
    "settings_editor_light_theme": "Thème clair",
    "settings_editor_preview_comment": "Aperçu style VS Code",
    "settings_editor_saved_message": "Le thème clair, le thème sombre, le mode d’apparence et les préférences de l’éditeur ont été enregistrés.",
    "settings_editor_show_rulers": "Afficher les règles",
    "settings_editor_show_rulers_hint": "Affiche des règles verticales aux colonnes 80 et 120.",
    "settings_editor_subtitle": "Ajustez l’apparence de l’éditeur pour retrouver une expérience proche de l’atelier VS Code.",
  ...
  "ja": <String, String>{
    ...
    "settings_editor_engine_flutter_code_editor": "Flutter Code Editor",
    "settings_editor_engine_flutter_code_editor_hint": "Flutter Code Editor は Flutter ネイティブのテキスト基盤のまま動作し、現在の折りたたみワークフローを維持します。",
    "settings_editor_engine_flutter_monaco": "Flutter Monaco",
    "settings_editor_engine_flutter_monaco_hint": "Monaco はプラットフォームの WebView/iframe バックエンドを使うため、大きなファイルでより良い挙動を期待できます。",
  ...
  "ru": <String, String>{
    ...
    "settings_editor_default_wrap_hint": "Открывать редакторы с включённым переносом строк по умолчанию.",
    "settings_editor_engine": "Движок редактора",
    "settings_editor_engine_flutter_code_editor": "Flutter Code Editor",
    "settings_editor_engine_flutter_code_editor_hint": "Flutter Code Editor остаётся полностью нативным для Flutter и сохраняет текущий сценарий сворачивания кода.",
    "settings_editor_engine_flutter_monaco": "Flutter Monaco",
    "settings_editor_engine_flutter_monaco_hint": "Monaco использует платформенный WebView/iframe и обычно лучше ведёт себя на больших файлах.",
    "settings_editor_font_size": "Размер шрифта",
    "settings_editor_footer": "Выберите отдельно светлую и тёмную темы редактора, а затем решите, следует ли редактору за внешним видом приложения или оставаться фиксированным.",
    "settings_editor_light_theme": "Светлая тема",
    "settings_editor_preview_comment": "Предпросмотр в стиле VS Code",
    "settings_editor_saved_message": "Светлая тема, тёмная тема, режим отображения и настройки редактора сохранены.",
    "settings_editor_show_rulers": "Показывать линейки",
    "settings_editor_show_rulers_hint": "Показывать вертикальные линейки на колонках 80 и 120.",
    "settings_editor_subtitle": "Настройте внешний вид редактора так, чтобы он был ближе к рабочему пространству VS Code.",
  ...
  "zh": <String, String>{
    ...
    "settings_editor_default_wrap_hint": "默认以自动换行方式打开编辑器。",
    "settings_editor_engine": "编辑器内核",
    "settings_editor_engine_flutter_code_editor": "Flutter Code Editor",
    "settings_editor_engine_flutter_code_editor_hint": "Flutter Code Editor 完全运行在 Flutter 原生文本体系中，并保留当前的代码折叠工作流。",
    "settings_editor_engine_flutter_monaco": "Flutter Monaco",
    "settings_editor_engine_flutter_monaco_hint": "Monaco 使用平台 WebView/iframe 后端，在较大文件场景下通常有更好的表现。",
    "settings_editor_font_size": "字体大小",
    "settings_editor_footer": "你可以分别设置浅色和深色编辑器主题，并决定编辑器是跟随应用外观还是保持固定模式。",
    "settings_editor_light_theme": "浅色主题",
    "settings_editor_preview_comment": "VS Code 风格预览",
    "settings_editor_saved_message": "浅色主题、深色主题、外观模式和编辑器偏好已保存。",
    "settings_editor_show_rulers": "显示标尺",
    "settings_editor_show_rulers_hint": "在第 80 和 120 列显示垂直标尺。",
    "settings_editor_subtitle": "将编辑器视觉风格调整为更接近 VS Code 的工作台体验。",
  ...
  "zh_Hant": <String, String>{
    ...
    "settings_editor_default_wrap_hint": "預設以自動換行方式開啟編輯器。",
    "settings_editor_engine": "編輯器核心",
    "settings_editor_engine_flutter_code_editor": "Flutter Code Editor",
    "settings_editor_engine_flutter_code_editor_hint": "Flutter Code Editor 完全使用 Flutter 原生文字編輯體系，並保留目前的程式碼折疊工作流程。",
    "settings_editor_engine_flutter_monaco": "Flutter Monaco",
    "settings_editor_engine_flutter_monaco_hint": "Monaco 採用平台 WebView/iframe 後端，在大型檔案情境下通常有更好的表現。",
    "settings_editor_font_size": "字型大小",
    "settings_editor_footer": "你可以分別設定淺色與深色編輯器主題，並決定編輯器要跟隨應用程式外觀或保持固定模式。",
    "settings_editor_light_theme": "淺色主題",
    "settings_editor_preview_comment": "VS Code 風格預覽",
    "settings_editor_saved_message": "淺色主題、深色主題、外觀模式與編輯器偏好已儲存。",
    "settings_editor_show_rulers": "顯示尺規",
    "settings_editor_show_rulers_hint": "在第 80 與 120 欄顯示垂直尺規。",
    "settings_editor_subtitle": "將編輯器的視覺風格調整為更接近 VS Code 的工作台體驗。",
    "settings_editor_tab_size": "Tab 大小",
