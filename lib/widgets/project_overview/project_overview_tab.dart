      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _HealthMetricItem(
              title: 'Branch',
              status: (project.workspaceCurrentBranch ?? project.repositoryCurrentBranch ?? '—'),
              description: 'Active workspace/repository branch',
              icon: Icons.alt_route,
              isEnabled: (project.workspaceCurrentBranch ?? project.repositoryCurrentBranch)
                      ?.trim()
                      .isNotEmpty ==
                  true,
            ),
          ...
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              actions: [
                TextButton(
                  onPressed:
                      transferring ? null : () => Navigator.of(dialogContext).pop(),
                  child: const Text('Cancel'),
                ),
                ElevatedButton(
          ...
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              actions: [
                TextButton(
                  onPressed:
                      deleting ? null : () => Navigator.of(dialogContext).pop(),
                  child: const Text('Cancel'),
                ),
                ElevatedButton(
